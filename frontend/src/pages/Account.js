          ...
          <div className="account-items">
            ...
            <div className="account-item account-address">
              ...
              <div className="account-address__top">
                <div className="account-address__left">
                  <img src="img/assets/account/map.jpg" alt="Address" />
                </div>
            ...
            <div className="account-item account-delivery">
              ...
              <div className="account-delivery__items">
                <div className="account-delivery__item"><span>по Москва-Сити </span>
                  <p>БЕСПЛАТНО (от 1500 руб.)</p>
                </div>
                <div className="account-delivery__item"><span>в радиусе ~10 км от Москва Сити</span>
                  <p>БЕСПЛАТНО (от 5 000 руб.)</p>
                </div>
                <div className="account-delivery__item"><span>по Москве (в приделах МКАД) </span>
